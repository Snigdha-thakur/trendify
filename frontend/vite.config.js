  ...
  build: {
    ...
    rollupOptions: {
      input: {
        ...
        'user-landing': './user/landing-page.html',
        'user-digital-tools': './user/digital-tools.html',
        'user-digital-training': './user/digital-training.html',
        'user-hosting': './user/hosting-services.html',
        'user-website': './user/website-design.html',
        'user-orders': './user/my-orders.html',
